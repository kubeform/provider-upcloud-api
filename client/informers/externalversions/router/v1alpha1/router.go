...
import (
	...
	v1alpha1 "kubeform.dev/provider-upcloud-api/client/listers/router/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.RouterV1alpha1().Routers(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.RouterV1alpha1().Routers(namespace).Watch(context.TODO(), options)
			},
		},
		&routerv1alpha1.Router{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *routerInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&routerv1alpha1.Router{}, f.defaultInformer)
}
