...
import (
	...
	v1alpha1 "kubeform.dev/provider-upcloud-api/client/listers/object/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ObjectV1alpha1().Storages(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ObjectV1alpha1().Storages(namespace).Watch(context.TODO(), options)
			},
		},
		&objectv1alpha1.Storage{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *storageInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&objectv1alpha1.Storage{}, f.defaultInformer)
}
