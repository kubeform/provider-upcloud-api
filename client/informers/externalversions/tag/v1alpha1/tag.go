...
import (
	...
	v1alpha1 "kubeform.dev/provider-upcloud-api/client/listers/tag/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.TagV1alpha1().Tags(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TagV1alpha1().Tags(namespace).Watch(context.TODO(), options)
			},
		},
		&tagv1alpha1.Tag{},
		resyncPeriod,
...
func (f *tagInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&tagv1alpha1.Tag{}, f.defaultInformer)
}
