...
import (
	v1alpha1 "kubeform.dev/provider-upcloud-api/apis/storage/v1alpha1"
...
// StorageV1alpha1Client is used to interact with features provided by the storage.upcloud.kubeform.com group.
type StorageV1alpha1Client struct {
	restClient rest.Interface
}

func (c *StorageV1alpha1Client) Storages(namespace string) StorageInterface {
