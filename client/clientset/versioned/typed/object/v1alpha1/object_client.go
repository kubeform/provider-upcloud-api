...
// ObjectV1alpha1Client is used to interact with features provided by the object.upcloud.kubeform.com group.
type ObjectV1alpha1Client struct {
	restClient rest.Interface
}

func (c *ObjectV1alpha1Client) Storages(namespace string) StorageInterface {
