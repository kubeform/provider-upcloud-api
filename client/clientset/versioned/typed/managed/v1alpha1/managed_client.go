...
type ManagedV1alpha1Interface interface {
	RESTClient() rest.Interface
	DatabaseLogicalDatabasesGetter
	DatabaseMysqlsGetter
	DatabasePostgresqlsGetter
	DatabaseUsersGetter
}
...
func NewForConfig(c *rest.Config) (*ManagedV1alpha1Client, error) {
	...
	return &ManagedV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new ManagedV1alpha1Client for the given config and
...
func New(c rest.Interface) *ManagedV1alpha1Client {
	return &ManagedV1alpha1Client{c}
}
