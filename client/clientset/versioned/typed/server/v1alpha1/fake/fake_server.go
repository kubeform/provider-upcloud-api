...
var serversResource = schema.GroupVersionResource{Group: "server.upcloud.kubeform.com", Version: "v1alpha1", Resource: "servers"}

var serversKind = schema.GroupVersionKind{Group: "server.upcloud.kubeform.com", Version: "v1alpha1", Kind: "Server"}
