...
import (
	v1alpha1 "kubeform.dev/provider-upcloud-api/apis/router/v1alpha1"
...
// RouterV1alpha1Client is used to interact with features provided by the router.upcloud.kubeform.com group.
type RouterV1alpha1Client struct {
	restClient rest.Interface
}

func (c *RouterV1alpha1Client) Routers(namespace string) RouterInterface {
