...
var routersResource = schema.GroupVersionResource{Group: "router.upcloud.kubeform.com", Version: "v1alpha1", Resource: "routers"}

var routersKind = schema.GroupVersionKind{Group: "router.upcloud.kubeform.com", Version: "v1alpha1", Kind: "Router"}
