...
type FakeIpAddresses struct {
	Fake *FakeFloatingV1alpha1
	ns   string
}

var ipaddressesResource = schema.GroupVersionResource{Group: "floating.upcloud.kubeform.com", Version: "v1alpha1", Resource: "ipaddresses"}

var ipaddressesKind = schema.GroupVersionKind{Group: "floating.upcloud.kubeform.com", Version: "v1alpha1", Kind: "IpAddress"}
...
func (c *FakeIpAddresses) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.IpAddress, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(ipaddressesResource, c.ns, name), &v1alpha1.IpAddress{})
...
func (c *FakeIpAddresses) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.IpAddressList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(ipaddressesResource, ipaddressesKind, c.ns, opts), &v1alpha1.IpAddressList{})
...
func (c *FakeIpAddresses) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(ipaddressesResource, c.ns, opts))
...
func (c *FakeIpAddresses) Create(ctx context.Context, ipAddress *v1alpha1.IpAddress, opts v1.CreateOptions) (result *v1alpha1.IpAddress, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(ipaddressesResource, c.ns, ipAddress), &v1alpha1.IpAddress{})
...
func (c *FakeIpAddresses) Update(ctx context.Context, ipAddress *v1alpha1.IpAddress, opts v1.UpdateOptions) (result *v1alpha1.IpAddress, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(ipaddressesResource, c.ns, ipAddress), &v1alpha1.IpAddress{})
...
func (c *FakeIpAddresses) UpdateStatus(ctx context.Context, ipAddress *v1alpha1.IpAddress, opts v1.UpdateOptions) (*v1alpha1.IpAddress, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(ipaddressesResource, "status", c.ns, ipAddress), &v1alpha1.IpAddress{})
...
func (c *FakeIpAddresses) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(ipaddressesResource, c.ns, name), &v1alpha1.IpAddress{})
...
func (c *FakeIpAddresses) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(ipaddressesResource, c.ns, listOpts)
...
func (c *FakeIpAddresses) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.IpAddress, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(ipaddressesResource, c.ns, name, pt, data, subresources...), &v1alpha1.IpAddress{})
